...
import { about, work, projects, education, certificates, blogs, achievements, contact, name, designation, location, pronouns, website } from './content.js.0b1094dd.mjs';
...
const $$Astro$a = createAstro("https://jakelorrenzesabal.github.io");
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/node_modules/astro-icon/lib/Icon.astro");
...
const $$Astro$9 = createAstro("https://jakelorrenzesabal.github.io");
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/node_modules/astro-icon/lib/Spritesheet.astro");

const $$Astro$8 = createAstro("https://jakelorrenzesabal.github.io");
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/node_modules/astro-icon/lib/SpriteProvider.astro");

const $$Astro$7 = createAstro("https://jakelorrenzesabal.github.io");
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/node_modules/astro-icon/lib/Sprite.astro");

Object.assign($$Sprite, { Provider: $$SpriteProvider });

const $$Astro$6 = createAstro("https://jakelorrenzesabal.github.io");
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/layouts/BaseLayout.astro");

const $$Astro$5 = createAstro("https://jakelorrenzesabal.github.io");
...
` })}`;
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/layouts/AccordionLayout.astro");

const $$Astro$4 = createAstro("https://jakelorrenzesabal.github.io");
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/components/Card.astro");

const $$Astro$3 = createAstro("https://jakelorrenzesabal.github.io");
const $$Container = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result, "AccordionLayout", $$AccordionLayout, { "title": "About", "icon": "mdi:account-badge-outline" }, { "default": ($$result2) => renderTemplate`${about}` })}
    ...
    return renderTemplate`${renderComponent($$result2, "Card", $$Card, { "title": item.title, "timeframe": item.issued, "description": item.org, "tags": item.description, "url": item.url, "url_name": "View Certificate" })}`;
  })}` })}

    ${renderComponent($$result, "AccordionLayout", $$AccordionLayout, { "title": "Blogs/Writings", "icon": "ic:round-edit-note" }, { "default": ($$result2) => renderTemplate`${blogs.map((item) => {
    return renderTemplate`${renderComponent($$result2, "Card", $$Card, { "title": item.title, "timeframe": item.date, "description": item.description, "tags": "", "url": item.url, "url_name": item.publisher })}`;
  })}` })}
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/components/Container.astro");

const $$Astro$2 = createAstro("https://jakelorrenzesabal.github.io");
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <article class="grid grid-cols-3 grid-rows-1 place-items-center w-[98vw] max-w-2xl">
    <div class="rounded-full border-primary self-end shadow-2xl md:w-24 w-20 aspect-square">
      <img src="/my-repo/profile.jpg" alt="profile_picture" class="object-cover w-full h-full rounded-full grayscale-[50] hover:grayscale-0">
    </div>
    ...
    <div class="md:grid text-right self-end hidden">
      <h6 class="text-sm text-text/70">${pronouns}</h6>
      <a${addAttribute(website, "href")} target="_blank" class="hover:text-blue-300 flex items-center justify-center">
        ${website}
      </a>
    </div>
  </article>
</header>`;
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/components/Header.astro");

const $$Astro$1 = createAstro("https://jakelorrenzesabal.github.io");
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="bg-background/5 flex justify-between items-center px-2 py-1 astro-SZ7XMLTE">
    <p class="astro-SZ7XMLTE">© 2023 Jake Lorenze B.Sabal</p>
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/components/Footer.astro");

const $$Astro = createAstro("https://jakelorrenzesabal.github.io");
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en">
	<head>
		<meta charset="utf-8">
		<link rel="icon" type="image/svg+xml" href="/my-repo/favicon.svg">
...
}, "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/pages/index.astro");

const $$file = "C:/Users/k/Desktop/jakelorrenzesabal.github.io/src/pages/index.astro";
const $$url = "/my-repo";
